...
During this assignment, I used several AI tools to support my learning process:

- **ChatGPT** – Used for explaining JavaScript concepts, debugging syntax errors, and understanding responsive design.
